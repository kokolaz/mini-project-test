...
public class RestaurantServiceTest {
    ...
    public void updateRestaurant_Success() throws Exception {
        ...
        when(restaurantRepository.save(any())).thenReturn(restaurantDao);
        ResponseEntity<Object> responseEntity = restaurantService.updateRestaurant(anyLong(), RestaurantDto.builder()
                .city(CityDto.builder()
                        .id(1L)
                        .build())
    ...
    public void updateRestaurant_Failed(){
        ...
        ResponseEntity<Object> responseEntity = restaurantService.updateRestaurant(anyLong(),RestaurantDto.builder().build());
...
//        ApiResponse apiResponse = (ApiResponse) responseEntity.getBody();
//        List<RestaurantDto> restaurantDtoList = (List<RestaurantDto>) apiResponse.getData();
//
